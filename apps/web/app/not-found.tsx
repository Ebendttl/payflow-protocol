...
export default function NotFound() {
  return (
    <div className="min-h-screen bg-dark-900 flex flex-col items-center justify-center gap-6 px-6 text-center">
      ...
      <div className="glass px-10 py-12 rounded-3xl border border-white/5 space-y-6 max-w-md z-10">
        <div className="text-7xl font-black bg-gradient-to-r from-primary-light to-accent-purple bg-clip-text text-transparent">
          404
        </div>
        ...
        <Link
          href="/"
          className="inline-flex items-center gap-2 bg-primary hover:bg-primary-light text-white px-6 py-3 rounded-xl font-semibold transition duration-200 shadow-lg shadow-primary/20"
        >
          Return to Dashboard
        </Link>
      </div>
