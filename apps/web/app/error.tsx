...
export default function Error({
  ...
  return (
    <div className="min-h-screen bg-dark-900 flex flex-col items-center justify-center gap-6 px-6 text-center">
      ...
      <div className="glass px-10 py-12 rounded-3xl border border-accent-rose/20 space-y-6 max-w-md z-10">
        ...
        <div className="flex gap-3">
          <button
            onClick={reset}
            className="flex-1 bg-primary hover:bg-primary-light text-white px-5 py-3 rounded-xl font-semibold transition duration-200 shadow-lg shadow-primary/20"
          >
            Try Again
          </button>
          <Link
